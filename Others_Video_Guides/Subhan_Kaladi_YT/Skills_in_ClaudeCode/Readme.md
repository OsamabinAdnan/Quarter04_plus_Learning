...
[Skills in Claude Code YouTube Link](https://www.youtube.com/watch?v=cP3Dd13wtss&list=WL&index=7)
[Skills in Claude Code Blog Link](https://yt-blogs.subhankaladi.xyz/blog/skills-in-claude-code)
...
-   **What they are:** Instructions and knowledge
-   **How they work:** Claude reads and follows rules
-   **Context:** Uses the main conversation context
-   **Invocation:** Automatic (Claude decides when to use)
-   **Complexity:** Simple and lightweight
-   **Best use case:** Repeated patterns, small steps, UI updates
...
-   **How they work:** Separate AI that performs tasks
-   **Context:** Has its own separate context window
-   **Invocation:** Automatic or explicitly called
-   **Complexity:** Advanced with full configuration
-   **Best use case:** Complete workflows, multi-step tasks

> **Memory tip:**  
> 🧩 _Skills guide Claude_  
> 🤖 _Sub-Agents do the work_
...
`.claude/skills/ └── modern-button/ └── SKILL.md`
