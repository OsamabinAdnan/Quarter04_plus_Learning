...
![Stream event types, "Stream events"](media/stream_events.png)

![Stream event sequence without tool "Stream events without tool"](media/stream_events%20sequence.png)

![Stream event sequence with tool, "Stream events with tool"](media/stream_events%20sequences%20with%20tool.png)
